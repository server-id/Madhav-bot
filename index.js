    ...
    child.on("close", (codeExit) => {
        if (codeExit !== 0) {
            ...
            if (global.countRestart < 5) {
                ...
                logger("To see detailed errors, check the logs above or run the bot with 'node Anurag.js' directly", "[ Debug ]");
            }
        } else {
...
try {
    ...
    axios.get("https://raw.githubusercontent.com/anuragmishra22071999-sudo/PRIYANSH-KI-DIDI-KI-CHUT-/main/package.json")
        ...
        .catch((err) => {
            ...
            logger(`Update check skipped: ${err.message}`, "[ Update Info ]");
        });
} catch (err) {
